...
set :application, "DenverBoulderEvents"
set :repository,  "git@github.com:brennanmeadowcroft/dbe_rails.git"
...
role :web, "samwell.asmallorange.com"                          # Your HTTP server, Apache/etc
role :app, "samwell.asmallorange.com"                          # This may be the same as your `Web` server
role :db,  "samwell.asmallorange.com", :primary => true # This is where Rails migrations will run

set :deploy_via, :copy

set :deploy_to,	"rails_apps/dbe"
set :user,		"denverbo"
set :use_sudo,	false
